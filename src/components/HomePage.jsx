...
export default function HomePage() {
  return (
    <div dir="rtl" className="fs-4 fw-semibold">
      <div className="  bg-light-indigo fs-4 fw-semibold ">
      ...
      <div>
        <div className="mt-5">
          <h1 className="text-center">התפתחות הילד לצפיה</h1>
          <div className="d-flex flex-column flex-xl-row  gap-5 justify-content-center align-items-center p-4">
